...
| `boot.rs` | `boot`-стадия: preload, firmware, хаптика, magisk |
| `otg.rs` | OTG-патч и VBUS-арбитраж (гейт: без ПК — host-форс; debounce опросов + settle; UDC-rebind в device-режиме) |
