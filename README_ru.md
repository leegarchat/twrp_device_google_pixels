...
> **Статус: публичное тестирование.** В релизе будет работать весь
> функционал OrangeFox — а **база полноценного рабочего OFox уже
> функционирует**: ADB, MTP, шифрование/расшифровка data,
> backup/restore, reflash recovery, прошивка образов. Остались мелкие
> отладки под конкретные семейства: вибрация, фонарики, OTG и подобные
> девайс-специфичные вещи.
