...
# TEST toggle: zuma C++ keymint from source instead of Rust prebuilt.
# FOX_ZUMA_CPP_KEYMINT=1 in the lunch shell; validated 0/1.
_ZUMA_CPP_KEYMINT="${FOX_ZUMA_CPP_KEYMINT:-0}"
case "$_ZUMA_CPP_KEYMINT" in
    0|1) ;;
    *) echo "  WARNING: bad FOX_ZUMA_CPP_KEYMINT='$_ZUMA_CPP_KEYMINT', defaulting to 0"; _ZUMA_CPP_KEYMINT=0 ;;
esac
# TEST toggle: zuma Rust keymint HAL from in-tree source instead of the
# vendor prebuilt. FOX_ZUMA_RUST_SRC_KEYMINT=1 in the lunch shell.
_ZUMA_RUST_SRC_KEYMINT="${FOX_ZUMA_RUST_SRC_KEYMINT:-0}"
case "$_ZUMA_RUST_SRC_KEYMINT" in
    0|1) ;;
    *) echo "  WARNING: bad FOX_ZUMA_RUST_SRC_KEYMINT='$_ZUMA_RUST_SRC_KEYMINT', defaulting to 0"; _ZUMA_RUST_SRC_KEYMINT=0 ;;
esac
...
ZUMA_CPP_KEYMINT=${_ZUMA_CPP_KEYMINT}
ZUMA_RUST_SRC_KEYMINT=${_ZUMA_RUST_SRC_KEYMINT}
_PLATFORM_EOF
